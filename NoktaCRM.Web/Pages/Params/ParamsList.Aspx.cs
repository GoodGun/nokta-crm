...
public partial class ParamsList : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Authorize();
        this.Master.SetTitles("List", "Params");
    ...
    private DataTable GetData(string sortExpression, int pageIndex, int pageSize, out int totalRows)
    {
        ...
        DataTable dt = CustomQueries.GetStuffByPage("admGetParamssByPage", GetFilter(), sortExpression, pageIndex + 1, pageSize, "*", out totalRows);
    ...
    private const string DefaultSort = "ParamsID DESC";
    ...
    protected void btnExportPDF_Click(object sender, EventArgs e)
    {
        ...
        string filePath = Exporter.Export(dt, Exporter.FileType.PDF, "list.Params");
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        int totalRows = 0;
        DataTable dt = GetData(grdData.OrderBy ?? DefaultSort, 0, 0, out totalRows);
        string filePath = Exporter.Export(dt, Exporter.FileType.Excel, "list.Params");
        spanExport.InnerHtml = filePath;
    }
    #endregion
}
