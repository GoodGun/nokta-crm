...
public partial class ContentList : BasePage
{
    ...
    {
        Authorize();
        this.Master.SetTitles("List", "Content");
    ...
    private DataTable GetData(string sortExpression, int pageIndex, int pageSize, out int totalRows)
    {
        ...
        DataTable dt = CustomQueries.GetStuffByPage("admGetContentsByPage", GetFilter(), sortExpression, pageIndex + 1, pageSize, "*", out totalRows);
    ...
    private const string DefaultSort = "ContentID DESC";
    ...
    protected void btnExportPDF_Click(object sender, EventArgs e)
    {
        ...
        string filePath = Exporter.Export(dt, Exporter.FileType.PDF, "list.Content");
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        int totalRows = 0;
        DataTable dt = GetData(grdData.OrderBy ?? DefaultSort, 0, 0, out totalRows);
        string filePath = Exporter.Export(dt, Exporter.FileType.Excel, "list.Content");
        spanExport.InnerHtml = filePath;
    }
    #endregion
}
