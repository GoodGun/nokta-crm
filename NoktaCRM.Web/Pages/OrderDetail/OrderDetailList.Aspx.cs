...
public partial class OrderDetailList : BasePage
{
    ...
    {
        Authorize();
        this.Master.SetTitles("List", "OrderDetail");
    ...
    private DataTable GetData(string sortExpression, int pageIndex, int pageSize, out int totalRows)
    {
        ...
        DataTable dt = CustomQueries.GetStuffByPage("admGetOrderDetailsByPage", GetFilter(), sortExpression, pageIndex + 1, pageSize, "*", out totalRows);
    ...
    private const string DefaultSort = "OrderDetailID DESC";
    ...
    protected void btnExportPDF_Click(object sender, EventArgs e)
    {
        ...
        string filePath = Exporter.Export(dt, Exporter.FileType.PDF, "list.OrderDetail");
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        int totalRows = 0;
        DataTable dt = GetData(grdData.OrderBy ?? DefaultSort, 0, 0, out totalRows);
        string filePath = Exporter.Export(dt, Exporter.FileType.Excel, "list.OrderDetail");
        spanExport.InnerHtml = filePath;
    }
    #endregion
}
